...
export function HeroSection() {
    return (
        <>
            <HeroHeader />
            <main className="overflow-hidden bg-gradient-to-b from-gray-950 via-black to-gray-950">
                <div
                    aria-hidden
                    className="z-[2] absolute inset-0 pointer-events-none isolate opacity-50 contain-strict hidden lg:block">
                    <div className="w-[35rem] h-[80rem] -translate-y-[350px] absolute left-0 top-0 -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,25%,.15)_0,hsla(0,0%,15%,.1)_50%,hsla(0,0%,10%,0)_80%)]" />
                    <div className="h-[80rem] absolute left-0 top-0 w-56 -rotate-45 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,25%,.12)_0,hsla(0,0%,15%,.08)_80%,transparent_100%)] [translate:5%_-50%]" />
                    <div className="h-[80rem] -translate-y-[350px] absolute left-0 top-0 w-56 -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,25%,.1)_0,hsla(0,0%,15%,.06)_80%,transparent_100%)]" />
                </div>
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                ...
                                alt="background"
                                className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block opacity-10"
                                width="3276"
                                height="4095"
                            />
                        </AnimatedGroup>
                        <div aria-hidden className="absolute inset-0 -z-10 size-full [background:radial-gradient(125%_125%_at_50%_100%,transparent_0%,rgba(17,24,39,0.95)_75%)]" />
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                />
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background/10 relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                ...
                <section className="bg-gradient-to-b from-gray-950 via-black to-gray-950 pb-16 pt-16 md:pb-32">
                ...
                <section id="features-unique" className="py-16 px-4 grid gap-12 md:gap-20 md:grid-cols-2 max-w-6xl mx-auto bg-gradient-to-b from-gray-950 via-black to-gray-950">
                    <div className="flex flex-col justify-center items-start">
                        <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white">Record with clarity</h3>
                        <p className="mb-4 text-gray-300">Studio-quality recording, audio/video split for each guest – no technical learning curve.</p>
                        <Button
                            asChild
                            variant="outline"
                            className="px-5 py-2 rounded-full border-2 border-purple-400 text-purple-400 font-bold hover:bg-purple-400/10 transition">
                            <Link href="/room">
                                <span>Try Recording</span>
                            </Link>
                        </Button>
                    </div>
                    <div className="rounded-3xl overflow-hidden shadow-xl bg-gradient-to-tr from-purple-900/20 to-blue-900/20 flex items-center justify-center min-h-[220px] border border-purple-500/20">
                        <img 
                            src="https://ext.same-assets.com/2843032294/2012210211.webp" 
                            alt="Recording UI" 
                            className="object-cover w-full h-full max-h-72" 
                        />
                    </div>
                </section>
                <section className="py-16 px-4 grid gap-12 md:gap-20 md:grid-cols-2 max-w-6xl mx-auto bg-gradient-to-b from-gray-950 via-black to-gray-950">
                    <div className="flex flex-col justify-center items-start order-2 md:order-1">
                        <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white">Edit intuitively</h3>
                        <p className="mb-4 text-gray-300">Remove silences, crosstalk, or drift in seconds. Use AI-powered tools to make editing a breeze.</p>
                        <Button
                            asChild
                            variant="outline"
                            className="px-5 py-2 rounded-full border-2 border-teal-400 text-teal-400 font-bold hover:bg-teal-400/10 transition">
                            <Link href="#">
                                <span>See Editor</span>
                            </Link>
                        </Button>
                    </div>
                    <div className="rounded-3xl overflow-hidden shadow-xl bg-gradient-to-tr from-teal-900/20 to-purple-900/20 flex items-center justify-center min-h-[220px] border border-teal-500/20">
                        <img 
                            src="https://ext.same-assets.com/2843032294/2637117745.webp" 
                            alt="Editor UI" 
                            className="object-cover w-full h-full max-h-72" 
                        />
                    </div>
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/10 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            ...
                            <button
                                ...
                                className="relative z-20 -m-2.5 -mr-4 block cursor-pointer p-2.5 lg:hidden text-gray-200">
                        ...
                        <div className="bg-background/10 group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className={cn(isScrolled && 'lg:hidden', 'border-gray-700 text-black-200 ')}>
                                    <Link href="#">
                                        <span>Login</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn(isScrolled && 'lg:hidden', 'bg-white text-gray-900 hover:bg-gray-100')}>
                                    <Link href="#">
                                        <span>Sign Up</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn(isScrolled ? 'lg:inline-flex' : 'hidden', 'bg-white text-gray-900 hover:bg-gray-100')}>
                                    <Link href="#">
